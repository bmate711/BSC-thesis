...
\newcommand{\vikszerzoKeresztnev}{Máté}
...
\newcommand{\vikkonzulensBVezeteknev}{Hullám}
...
\newcommand{\vikcim}{Robotos pakolási műveletek hatékony tervezése} % Cím
...
\include{content/irodalmi_attekintes}
\include{content/feladat_definicio}
\include{content/megoldas}
\include{content/implementacio}
